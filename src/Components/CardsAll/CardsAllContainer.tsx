...
import {fetchCountriesPending, fetchCountriesSuccess, fetchCountriesError} from '../../Redux/GetApi/actions';
import {getCountries, getCountriesPending, getCountriesError} from '../../Redux/GetApi/reducer';
...
const CardsAllContainer = connect(mapStateToProps, mapDispatchToProps)(CardsAll);
